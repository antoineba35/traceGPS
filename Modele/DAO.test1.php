...
echo "<h3>Test de Antoine Barré : </h3>";
// A CONTINUER .........
...
if ($dao->existeAdrMailUtilisateur("delasalle.sio.eveno.b@gmail.com")) $existe = "oui"; else $existe = "non";
echo "Existence de l'utilisateur 'delasalle.sio.eveno.b@gmail.com' : <b>" . $existe . "</b></br>";
